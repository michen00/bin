...
- [`analyse_csv`](https://github.com/michen00/bin/blob/main/analyse_csv): Analyze a CSV file to calculate basic statistics (mean, median, and unique values) for numeric and text columns and detect missing values.
